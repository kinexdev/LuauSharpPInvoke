...
LUAU_API char* Luau_compile(const char* source, size_t* size); //implemented C#
...
// LUACODE_API void Luau_pushliterals(lua_State* L, const char* s); not working idk
LUAU_API void Luau_pushcfunction(lua_State* L, lua_CFunction fn, const char* debugname); //implemented C#
